...
include 'db_connect.php';
    ...
    if ($query = $db->query("SELECT * FROM categories ORDER BY name")){
        ...
        // Загружаем товары
        if ($query = $db->query(" SELECT * FROM products WHERE num = ".$SectionNum." AND hide = 1 ORDER BY name_prod ")){
          ...
          <div class="content fonts">
              ...
              <div class="content_item">
                ...
                <div class="product fonts">
                  <a href="<?php echo $SectionNameAn; ?>/<?php echo $product['number']; ?>" class="links">
